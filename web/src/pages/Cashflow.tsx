          ...
          <div className="card">
            <h2>
              ...
              <HelpTip title="全支出の内訳と算出式">
                ...
                {'\n'}　非投資の資産増減 = Δ現金 + Δ投資元本（Δ投資元本 = Δ投資 − その月の投資増減。投資の値動きを排除し、積立などの資産間移動は支出になりません）
                {'\n'}・年金は値動きがこの増減に含まれず、拠出も給与天引き（手取り外）のため計算から除外しています
                ...
                {'\n'}・当月末と前月末の両方に資産記録（投資・現金）があり、当月に「今月の投資増減」の記録があることが算出の条件です（フロー値なので前月の値は不要）
              </HelpTip>
            </h2>
            ...
            <p className="muted" style={{ fontSize: 12, marginBottom: 0 }}>
              ...
              算出には前月末と当月末の資産記録（投資・現金）と、当月の「今月の投資増減」が必要です。
