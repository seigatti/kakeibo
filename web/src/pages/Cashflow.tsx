          ...
          <div className="card">
            <h2>
              ...
              <HelpTip title="全支出の内訳と算出式">
                ...
                {'\n'}　非投資の資産増減 = Δ現金 + Δ投資元本（Δ投資元本 = Δ投資 − その月の評価損益。投資の値動きを排除し、積立などの資産間移動は支出になりません）
                ...
                {'\n'}・当月末と前月末の両方に資産記録（投資・現金）があり、当月に評価損益の記録があることが算出の条件です（評価損益はその月の増減なので、前月の値は不要）
              </HelpTip>
            </h2>
            ...
            <p className="muted" style={{ fontSize: 12, marginBottom: 0 }}>
              ...
              算出には前月末と当月末の資産記録（投資・現金）と、当月の評価損益が必要です。
            ...
            <Collapsible title="その他支出の内訳（診断用）" hint={`${chartMonths.length}ヶ月`}>
                ...
                <table style={{ fontSize: 11, borderCollapse: 'collapse', whiteSpace: 'nowrap', width: '100%' }}>
                  <thead>
                    <tr className="muted">
                      ...
                      <th style={{ padding: 3, textAlign: 'right' }}>評価損益</th>
              ...
              <p className="muted" style={{ fontSize: 11, margin: '6px 0 0' }}>
                Δ投資元本 = Δ投資 − その月の評価損益（その月の積立・売却の純額に相当）。
